...
const Navbar = () => {
    ...
    return (
        <motion.nav
            ...
            className="fixed top-0 left-0 right-0 z-50 py-3 bg-white shadow-sm border-b border-slate-200/50 transition-all duration-300"
        >
                            ...
                            return (
                                <Link
                                    ...
                                    className={`relative py-1 font-medium tracking-[0.2em] uppercase text-[11px] transition-colors duration-200 ${isActive
                                        ? 'text-cobalt border-b border-cobalt'
                    ...
                    <div className="flex items-center gap-3">
                        <Link to="/contact">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="px-5 py-2 text-[10px] font-medium tracking-[0.18em] uppercase rounded-full border border-cobalt text-cobalt hover:bg-cobalt hover:text-white transition-all duration-300"
                            >
                                Start Project
                            </motion.button>
                        </Link>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed inset-0 top-[64px] z-40 bg-white/98 backdrop-blur-2xl md:hidden overflow-y-auto"
                    >
