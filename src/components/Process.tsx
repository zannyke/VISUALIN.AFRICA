...
const Process = () => {
    return (
        <section id="process" className="py-28 bg-black transition-colors duration-300">
            <div className="container mx-auto px-6 max-w-6xl">
                <div className="mb-20 text-center">
                    <motion.span 
                        ...
                        viewport={{ once: true }}
                        className="text-white/60 font-medium tracking-[0.2em] uppercase text-[10px] mb-3 block"
                    >
                        Our Process
                    </motion.span>
                    <motion.h2
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="text-4xl md:text-5xl font-serif font-normal text-white"
                    >
                        How We Work
                    </motion.h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16 relative">
                    {steps.map((step, index) => (
                        ...
                        >
                            <div className="text-6xl font-serif font-normal text-white/10 mb-6 select-none transition-transform group-hover:scale-105 duration-500">
                                {step.num}
                            </div>
                            <h3 className="text-xl font-serif font-normal italic text-white mb-4">{step.title}</h3>
