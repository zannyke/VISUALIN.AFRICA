...
interface FooterProps {
    ctaTheme?: 'white' | 'black';
}

const Footer = ({ ctaTheme = 'white' }: FooterProps) => {
    return (
        <>
            <CTA theme={ctaTheme} />
            <footer className="relative bg-black text-white pt-20 pb-12 overflow-hidden border-t border-white/10">
                ...
                <div className="absolute bottom-0 left-0 w-full h-[400px] bg-gradient-to-t from-white/5 to-transparent pointer-events-none" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div className="md:col-span-2">
                        <a
                            href="#"
                            className="font-serif font-bold tracking-tighter text-white mb-6 block"
                            style={{ fontSize: "var(--text-fluid-h3)" }}
                        >
                            Visualink<span className="text-cobalt">.</span>
                        </a>
                        <p
                            className="text-white/70 max-w-sm leading-relaxed"
                        ...
                        <div className="flex gap-4 mt-6">
                            ...
                            <a
                                ...
                                className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-cobalt hover:text-white hover:scale-110 transition-all duration-300 border border-white/10"
                            >
                                <Instagram size={20} />
                            </a>
                            {/* TikTok */}
